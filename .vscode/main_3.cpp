...
//std::cout<<"1"<<framesCounter<<std::endl;
...
std::cout<<"2"<<framesCounter<<std::endl;
...
/*
    // Calls and plays the fxButton Audio - short cricket type sound, lets user know itsbeen clicked;
               ...
               */
        std::cout<<"3"<<framesCounter<<std::endl;
...
//----------------------------------------------------------------------------------
    std::cout<<"4th"<<framesCounter<<std::endl;
 ...
 switch(currentScreen)
            {
                case PRESCREEN:
                {
                    // TODO: Draw SPIDERMAN LOGO on a black bg here.
                     std::cout<<"5th"<<framesCounter<<std::endl;
